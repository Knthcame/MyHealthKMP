...
class AddEventViewModelTest {
    ...
    @Test
    fun editEventDate_updatesState_onCall() =
        runTest {
            sut.uiState.test {
                awaitItem()
    ...
    @Test
    fun editEventTime_updatesState_onCall() =
        runTest {
            sut.uiState.test {
                awaitItem()
    ...
    @Test
    fun editEventValue_updatesState_onCall() =
        runTest {
            sut.uiState.test {
                awaitItem()
    ...
    @Test
    fun editEventType_updatesState_onCall() =
        runTest {
            sut.uiState.test {
    ...
    @Test
    fun saveEvent_savesEventInRepository_onCall() =
        runTest {
            sut.uiState.test {
                val state = awaitItem()
