...
class DefaultDiaryRepositoryTest {
    ...
    @Test
    fun diaryEvents_returnsEmptyList_whenNoDataIsAvailable() =
        runTest {
            initRepository()
     ...
     * **/
    @Test
    fun diaryEvents_mapsSleepEvents_whenAvailable() =
        runTest {
     ...
     * **/
    @Test
    fun diaryEvents_mapsActivityEvents_whenAvailable() =
        runTest {
    ...
    @Test
    fun diaryEvents_sortsEventsByTimestampDescending() =
        runTest {
    ...
    @Test
    fun delete_deletesActivityById_whenEventTypeIsActivity() =
        runTest {
            val id = 4
            initRepository()
    ...
    @Test
    fun delete_deletesSleepById_whenEventTypeIsSleep() =
        runTest {
            val id = 9
            initRepository()
    ...
    @Test
    fun save_addsActivity_whenEventTypeIsActivity() =
        runTest {
    ...
    @Test
    fun save_addsSleep_whenEventTypeIsSleep() =
        runTest {
